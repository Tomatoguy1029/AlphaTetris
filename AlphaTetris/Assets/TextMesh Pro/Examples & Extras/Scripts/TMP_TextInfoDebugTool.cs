...
namespace TMPro.Examples {
  public class TMP_TextInfoDebugTool : MonoBehaviour {
    ...
    private void OnDrawGizmos() {
      ...
      ObjectStats = "Characters: " + m_TextInfo.characterCount + "   Words: " + m_TextInfo.wordCount + "   Spaces: " +
                    m_TextInfo.spaceCount + "   Sprites: " + m_TextInfo.spriteCount + "   Links: " +
    ...
    private void DrawCharactersBounds() {
      ...
      for (var i = 0; i < characterCount; i++) {
        ...
        var bottomRight =
          m_Transform.TransformPoint(new Vector3(characterInfo.bottomRight.x, characterInfo.bottomRight.y, 0));
        ...
        if (characterInfo.isVisible) {
          ...
          DrawDottedRectangle(m_Transform.TransformPoint(new Vector3(characterInfo.origin, characterInfo.descender, 0)),
            m_Transform.TransformPoint(new Vector3(whiteSpaceAdvance, characterInfo.ascender, 0)), color, 4);
        }
